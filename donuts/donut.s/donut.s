...
addss %xmm2,%xmm0;mulss %xmm0,%xmm1;movss .LC8(%rip),%xmm0;addss %xmm1,%xmm0;
 addss %xmm2,  %xmm0;  mulss %xmm0, %xmm1;  movss                                                   .LC8(%rip),    %xmm0;    addss  %xmm1,    %xmm0;
cvttss2sil %xmm0,%eax;movl %eax,-8828(%rbp);movl -8828(%rbp),%edx;movl %edx,%eax; sall $2,%eax;addl %edx,%eax;sall $4,%eax;movl %eax,%edx;movl -8832(%rbp),%eax;addl %edx,%eax; movl %eax,-8824(%rbp);movss -8864(%rbp),%xmm0;mulss -8868(%rbp),%xmm0; movss -8876(%rbp),%xmm1;mulss -8872(%rbp),%xmm1;mulss -8860(%rbp),%xmm1; subss %xmm1,%xmm0;mulss -8844(%rbp),%xmm0;movss -8876(%rbp),%xmm1; mulss -8872(%rbp),%xmm1;mulss -8868(%rbp),%xmm1;subss %xmm1,%xmm0; movss -8864(%rbp),%xmm1;mulss -8860(%rbp),%xmm1;subss %xmm1,%xmm0; movss -8848(%rbp),%xmm1;mulss -8872(%rbp),%xmm1;movaps %xmm1,%xmm2; mulss -8840(%rbp),%xmm2;movaps %xmm0,%xmm1;subss %xmm2,%xmm1;movss .LC9(%rip),%xmm0; mulss %xmm1,%xmm0;cvttss2sil %xmm0,%eax;movl %eax,-8820(%rbp);cmpl $21,-8828(%rbp); jg .L4;cmpl $0,-8828(%rbp);jle .L4;cmpl $0,-8832(%rbp);jle .L4;cmpl $79,-8832(%rbp); jg .L4;movl -8824(%rbp),%eax;cltq;movss -8816(%rbp,%rax,4),%xmm1;movss -8852(%rbp),%xmm0; comiss %xmm1,%xmm0;jbe .L4;movl -8824(%rbp),%eax;cltq;movss -8852(%rbp),%xmm0; movss %xmm0,-8816(%rbp,%rax,4);movl -8820(%rbp),%eax;movl $0,%edx;testl %eax,%eax; cmovs %edx,%eax;cltq;leaq .LC10(%rip),%rdx;movzbl (%rax,%rdx),%edx;movl -8824(%rbp),%eax; cltq;movb %dl,-1776(%rbp,%rax);.L4:;pxor %xmm1,%xmm1;cvtss2sd -8884(%rbp),%xmm1; movsd .LC11(%rip),%xmm0;addsd %xmm1,%xmm0;cvtsd2ss %xmm0,%xmm0;movss %xmm0,-8884(%rbp);.L3: pxor %xmm1,%xmm1;cvtss2sd -8884(%rbp),%xmm1;movsd .LC12(%rip),%xmm0;comisd %xmm1,%xmm0;ja .L6; pxor %xmm1,%xmm1;cvtss2sd -8880(%rbp),%xmm1;movsd .LC13(%rip),%xmm0;addsd %xmm1,%xmm0; cvtsd2ss %xmm0,%xmm0;movss %xmm0,-8880(%rbp);.L2:;pxor %xmm1,%xmm1;cvtss2sd -8880(%rbp),%xmm1; movsd .LC12(%rip),%xmm0;comisd %xmm1,%xmm0;ja .L7;leaq .LC14(%rip),%rax;movq %rax,%rdi;movl $0,%eax; call printf@PLT;movl $0,k(%rip);jmp .L8;.L11:;movl k(%rip),%ecx;movslq %ecx,%rax;imulq $1717986919,%rax,%rax; shrq $32,%rax;movl %eax,%edx;sarl $5,%edx;movl %ecx,%eax;sarl $31,%eax;subl %eax,%edx;movl %edx,%eax;sall $2,%eax;addl %edx,%eax; sall $4,%eax;subl %eax,%ecx;movl %ecx,%edx;testl %edx,%edx;je .L9;movl k(%rip),%eax;cltq;movzbl -1776(%rbp,%rax),%eax;movsbl %al,%eax; jmp .L10;.L9:;movl $10,%eax;.L10:;movl %eax,%edi;call putchar@PLT;movl k(%rip),%eax;addl $1,%eax;movl %eax,k(%rip);.L8: movl k(%rip),%eax;cmpl $1760,%eax;jle .L11;pxor %xmm1,%xmm1;cvtss2sd -8892(%rbp),%xmm1;movsd .LC15(%rip),%xmm0;addsd %xmm1,%xmm0; cvtsd2ss %xmm0,%xmm0;movss %xmm0,-8892(%rbp);pxor %xmm1,%xmm1;cvtss2sd -8888(%rbp),%xmm1;movsd .LC11(%rip),%xmm0; addsd %xmm1,%xmm0;cvtsd2ss %xmm0,%xmm0;movss %xmm0,-8888(%rbp);jmp .L12
        ...
        jmp .L10; .L9: movl $10, %eax; .L10:  movl %eax, %edi; call putchar@PLT; movl k(%rip), %eax; addl $1,  %eax; movl %eax, k(%rip); .L8:
         movl k(%rip),%eax;cmpl $1760,%eax;jle .L11; pxor %xmm1,%xmm1;cvtss2sd -8892(%rbp),%xmm1; movsd .LC15(%rip),%xmm0;addsd %xmm1,%xmm0;
          cvtsd2ss %xmm0,  %xmm0; movss  %xmm0, -8892(%rbp);  pxor %xmm1,  %xmm1; cvtss2sd  -8888(%rbp), %xmm1;  movsd  .LC11(%rip), %xmm0;
           addsd      %xmm1,      %xmm0;      cvtsd2ss      %xmm0,       %xmm0;      movss      %xmm0,      -8888(%rbp);      jmp      .L2
            //...........................................................................................................................
              //.......................................................................................................................
               //.....................................................................................................................
                 //.................................................................................................................
